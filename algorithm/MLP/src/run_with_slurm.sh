...
conda run -n ml-env python /fastwork/apaolino/element_ml-for-aerodynamics/algorithm/MLP/src/main.py /fastwork/apaolino/element_ml-for-aerodynamics/algorithm/MLP/test_cases/ironcub/input.cfg
