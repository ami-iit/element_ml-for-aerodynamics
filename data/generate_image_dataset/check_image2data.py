...
def main():
    ...
    for surface_index in range(len(robot.surface_list)):
        ...
        surface_world_H_link = robot_ref.compute_world_to_link_transform(frame_name=robot.surface_frames[surface_index])
    ...
    flow.interpolate_flow_data_from_image(fluent_data_path, robot.surface_list, robot.surface_axes, link_H_world_ref_dict, world_H_link_dict, joint_config_name_ref, pitch_angle_ref, yaw_angle_ref)
