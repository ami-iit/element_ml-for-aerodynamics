...
from src.dual_flow import FlowImporter
...
def main():
    ...
    for config_name in config_names:
        ...
        with open(str(dataset_dir / f"ironcub-{config_name}-dual.npz"), "wb") as f:
            pickle.dump(dataset[config_name], f, protocol=4)
        print(f"Dual image dataset for {config_name} configuration saved.")
