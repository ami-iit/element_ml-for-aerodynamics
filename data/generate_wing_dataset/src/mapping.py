...
def plot_mapping(original_map, redistributed_map, values, wing_name):
...
def density_cdf_warping(points):
    ...
    kde_x = KernelDensity(bandwidth=0.1, kernel="gaussian")
    ...
    kde_y = KernelDensity(bandwidth=0.1, kernel="gaussian")
